...
---
I used to do hobbyist game development for some years. Some of the projects can be found on the [Devcarpet](https://devcarpet.net) page, with my two favourites - [Deer Portal]() and [Deer Shifter]() - the second one has been developed for the Game Jam Ludum Dare.
...
For the VCS I chose [Gogs](https://gogs.io/) hosted on my Raspberry Pi at home. It provides me with Git functionality, a simple Wiki and the Issues for the project. Perfect bare-bone minimum.
